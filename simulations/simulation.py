...
class BaseSimulation(TaskManager):
    """
    The main logic to run simulations with the various algorithms included in DeScan.
    ...
    async def start_ipv8_nodes(self) -> None:
        for peer_id in range(1, self.settings.peers + 1):
            ...
            instance = IPv8(config.finalize(), endpoint_override=endpoint,
                            extra_communities={'SkipGraphCommunity': SkipGraphCommunity,
